          ...
          <div className="w-full h-full group">
            {previewType === 'icon' ? (
              <div className="flex min-h-[160px] items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200">
                <div className="rounded-2xl border border-white/80 bg-white/90 px-5 py-4 shadow-xl">
                  ...
                  {!previewFailed ? (
                    ...
                    <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-[10px] font-black uppercase tracking-widest text-white">
                      ICO
                    </div>
                  )}
                </div>
              ...
              <div className="flex h-40 items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200">
                <div className="rounded-2xl bg-white px-4 py-3 text-[10px] font-black uppercase tracking-widest text-primary shadow-lg">
                  Preview unavailable
                </div>
              </div>
            )}
