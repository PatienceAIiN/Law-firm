      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 bg-white py-3 pl-11 pr-4 text-sm font-medium text-[#0f172a] outline-none transition-colors focus:border-primary"
          />
        </div>
        ...
        {selectedConversation ? (
          <div className="space-y-5">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-4">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.24em] text-primary">Conversation</p>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 px-3 py-2 text-[10px] font-black uppercase tracking-[0.22em] text-slate-600 transition-colors hover:border-primary hover:text-primary"
              >
              ...
              {selectedConversation.messages.map((message, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    message.role === 'user'
                      ? 'ml-auto border-primary/10 bg-primary text-white'
