  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-black text-primary uppercase tracking-tighter">Availability Calendar</h2>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="px-4 py-3 rounded-2xl bg-white border border-gray-100 text-sm font-black text-primary uppercase tracking-widest">
            {monthLabel(month)}
          </div>
          <button onClick={() => loadMonth(shiftMonth(month, 1))} className="p-3 rounded-2xl bg-white border border-gray-100 hover:bg-gray-50">
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="text-lg font-black text-primary">{Number(date.slice(-2))}</div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-3 gap-4">
            <div className="rounded-2xl bg-gray-50 p-4">
              ...
              <div className="text-2xl font-black text-primary">{selectedDay?.totalSlots || 0}</div>
            </div>
            <div className="rounded-2xl bg-gray-50 p-4">
              <div className="text-[10px] font-black uppercase tracking-widest text-gray-400">Available Seats</div>
              <div className="text-2xl font-black text-primary">{selectedDay?.availableSlots || 0}</div>
            </div>
            <div className="rounded-2xl bg-gray-50 p-4">
              <div className="text-[10px] font-black uppercase tracking-widest text-gray-400">Booked Seats</div>
              <div className="text-2xl font-black text-primary">{selectedDay?.bookedSlots || 0}</div>
            </div>
          </div>
                  ...
                  {isEditing ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <button
                        ...
                        className="md:col-span-2 w-full bg-primary text-white p-3 rounded-2xl font-black uppercase tracking-widest flex items-center justify-center gap-2"
                      >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {slot.allowedModes.map((mode) => (
                        <span key={mode} className="px-3 py-1 rounded-full bg-gray-50 text-[10px] font-black uppercase tracking-widest text-primary">
          ...
          <div className="border-t border-gray-100 pt-6 space-y-4">
            ...
            <button onClick={submitNewSlot} className="w-full bg-[#F6F0E8] text-primary p-4 rounded-2xl font-black uppercase tracking-widest flex items-center justify-center gap-2">
