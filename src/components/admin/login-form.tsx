  ...
  if (mode === 'done') {
    return (
      <div className="text-center space-y-4">
        ...
        <h3 className="text-lg font-bold text-primary">Password Reset Successfully</h3>
        <p className="text-sm text-gray-500">You can now sign in with your new password.</p>
        <Button
          onClick={backToLogin}
          className="w-full bg-primary hover:bg-accent text-white rounded-xl font-bold"
        >
          Go to Login
        </Button>
      </div>
      ...
      <form className="space-y-5" onSubmit={handleResetPassword}>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-gray-200 text-2xl font-black tracking-[0.5em] text-center text-primary outline-none focus:ring-2 focus:ring-[#14203E]/30"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm text-primary outline-none focus:ring-2 focus:ring-[#14203E]/30 pr-10"
            />
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm text-primary outline-none focus:ring-2 focus:ring-[#14203E]/30"
          />
        </div>
        ...
        <Button
          type="submit"
          disabled={fpLoading}
          className="w-full bg-primary hover:bg-accent text-white rounded-xl font-bold py-3 h-auto"
        >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 text-sm text-primary outline-none focus:ring-2 focus:ring-[#14203E]/30"
            />
          </div>
        </div>
    ...
    <form className="space-y-6" onSubmit={handleLogin}>
      ...
      <div>
        <Button
          ...
          disabled={isLoading}
          className={cn(
            'w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#14203E]',
