...
export function ClientSidebar({
  ...
  const renderNavItem = (item: (typeof navigation)[number], isMobile = false) => {
    ...
    const className = cn(
      ...
      isActive
        ? 'bg-[#14203E] text-white shadow-xl shadow-[#14203E]/15 border-[#14203E]'
        : 'border-gray-200 text-slate-600 hover:bg-slate-50 hover:text-[#14203E] hover:border-gray-300',
    ...
    const content = (
      <>
        <div className="flex min-w-0 items-center gap-3">
          <span
            className={cn(
              ...
              isActive ? 'bg-white/10 text-[#14203E]' : 'bg-slate-100 text-[#0f172a] group-hover:bg-slate-200'
            )}
          >
        ...
        {isActive && <span className="h-2 w-2 rounded-full bg-[#F6F0E8]" />}
      </>
    )
    ...
    <div className="flex h-full flex-col border-r border-gray-200 bg-white">
      <div className="border-b border-gray-200 bg-gray-50/60 px-5 py-5">
        <Link href="/" className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#14203E] text-xl font-black text-white shadow-lg">
            {brand?.logo_text || 'SA'}
          </div>
      ...
      <div className="border-t border-gray-200 bg-gray-50/60 p-4">
        <div className="rounded-2xl border border-gray-200 bg-white p-4">
          <p className="text-[10px] font-black uppercase tracking-[0.24em] text-[#14203E]">Contact</p>
          <div className="mt-3 space-y-3 text-sm text-slate-700">
            <div className="flex items-center gap-3">
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#14203E]/5 text-[#0f172a]">
    ...
    <>
      ...
      <div className="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur lg:hidden">
        <div className="flex items-center justify-between px-3 py-3 sm:px-4">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#14203E] text-lg font-black text-white shadow-lg">
              {brand?.logo_text || 'SA'}
            </div>
            <div className="min-w-0">
              <p className="whitespace-nowrap text-sm font-black uppercase tracking-[0.22em] text-[#0f172a]">
          ...
          <button
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-gray-200 bg-white text-slate-500 transition-colors hover:text-[#14203E]"
