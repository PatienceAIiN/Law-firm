      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-[#14203E] leading-tight">
            ...
            <span className="text-[#14203E]">{section.title?.split(' ').slice(1).join(' ') || 'Articles & Insights'}</span>
          </h2>
          ...
          {data.map((post) => (
            ...
            >
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <h3 className="text-xl font-bold text-[#14203E] mb-4 group-hover:text-[#14203E] transition-colors line-clamp-2 leading-tight">
                  {post.title}
                </h3>
                ...
                <div className="inline-flex items-center text-[#14203E] font-bold text-sm tracking-tight border-b-2 border-[#F4E8D8] pb-1 self-start group-hover:border-[#14203E] transition-all mt-auto">
                  READ ARTICLE
        ...
        <div className="text-center mt-16">
          <Button asChild variant="outline" className="border-[#14203E] text-[#14203E] hover:bg-[#14203E] hover:text-white px-8 py-6 rounded-xl font-bold">
