...
export function ContactCTA({ metrics, content }: ContactCTAProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-[#fbfcfe] to-white py-20 text-primary">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center rounded-full border border-[#F4E8D8]/30 bg-[#F6F0E8]/15 px-3 py-1 text-[10px] font-black uppercase tracking-[0.24em] text-primary">
          ...
          <h2 className="mt-5 text-3xl font-black uppercase tracking-tighter lg:text-5xl">
            ...
            <span className="text-primary">{section.title?.split(' ').slice(4).join(' ') || 'Legal Needs?'}</span>
          </h2>
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Button asChild size="lg" className="group h-14 rounded-2xl border border-primary bg-primary px-8 font-black uppercase tracking-widest text-white transition-all duration-300 hover:-translate-y-1 hover:bg-[#F6F0E8] hover:text-primary hover:shadow-2xl hover:shadow-black/20">
              <Link href="/contact">
