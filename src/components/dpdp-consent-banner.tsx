    ...
    <div className="fixed inset-x-0 bottom-0 z-[200] animate-[slideUp_0.4s_ease-out] px-4 pb-4 sm:px-6">
      <div className="mx-auto max-w-2xl overflow-hidden rounded-2xl border border-[#F4E8D8] bg-white shadow-2xl ring-1 ring-black/5 dark:border-white/10 dark:bg-[#161b28] dark:ring-white/5">
        ...
        <div className="flex items-center gap-3 border-b border-[#F4E8D8] bg-[#FFFCF8] px-5 py-3.5 dark:border-white/10 dark:bg-[#1a2033]">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#14203E] text-white dark:bg-white/10">
            <Shield className="h-4 w-4" />
          </div>
          <h3 className="text-[15px] font-bold text-[#14203E] dark:text-white">
            Data Protection Notice
          </h3>
          <span className="ml-auto rounded-full bg-[#14203E]/8 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[#14203E]/70 dark:bg-white/10 dark:text-white/60">
            DPDP Act 2023
          </span>
        </div>
        ...
        <div className="px-5 py-4">
          <p className="text-[13px] leading-relaxed text-[#14203E]/75 dark:text-white/65">
            We value your privacy. In accordance with India&apos;s{' '}
            <strong className="font-semibold text-[#14203E] dark:text-white">
          ...
          <p className="mt-2 text-[12px] text-[#14203E]/55 dark:text-white/45">
            Read our{' '}
            <Link href="/privacy" className="font-medium text-[#14203E] underline decoration-dotted underline-offset-2 hover:text-[#14203E]/80 dark:text-white/80 dark:hover:text-white">
              Privacy Policy
            </Link>{' '}
        ...
        <div className="flex items-center justify-end gap-3 border-t border-[#F4E8D8] bg-[#FFFCF8]/60 px-5 py-3.5 dark:border-white/10 dark:bg-[#1a2033]/60">
          <button
            ...
            disabled={saving}
            className="rounded-xl border border-[#14203E]/15 px-5 py-2 text-[13px] font-semibold text-[#14203E]/70 transition-colors hover:bg-[#14203E]/5 disabled:opacity-50 dark:border-white/15 dark:text-white/60 dark:hover:bg-white/5"
          >
            Deny
          </button>
          <button
            ...
            disabled={saving}
            className="rounded-xl bg-[#14203E] px-5 py-2 text-[13px] font-semibold text-white transition-colors hover:bg-[#1d2c52] disabled:opacity-50 dark:bg-white dark:text-[#14203E] dark:hover:bg-white/90"
          >
