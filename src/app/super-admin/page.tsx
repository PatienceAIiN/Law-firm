                  ...
                  <tr key={tenant.id}>
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <Link href={`/t/${tenant.slug}`} target="_blank" className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-xs font-medium text-[#14203E] hover:bg-slate-100 dark:text-white dark:hover:bg-white/10">
