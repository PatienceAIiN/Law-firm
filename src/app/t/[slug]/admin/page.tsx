    ...
    <TenantAdminShell tenant={tenant} currentUser={currentUser}>
          ...
          return (
            ...
            >
              <div>
                ...
                <p className="mt-1 text-3xl font-bold text-[var(--primary)] dark:text-white">{counts[c.key] ?? 0}</p>
              </div>
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--primary)] text-white group-hover:bg-[var(--accent)]">
      ...
      <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-[#11151f]">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-sm font-bold text-[var(--primary)] dark:text-white">Your public site</h2>
          ...
          <Link href={`/t/${tenant.slug}`} target="_blank" className="inline-flex items-center gap-1.5 rounded-lg bg-[var(--primary)] px-4 py-2 text-xs font-semibold text-white hover:bg-[var(--accent)]">
