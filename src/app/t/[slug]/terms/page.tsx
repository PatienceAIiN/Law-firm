  ...
  return (
    <MarketingShell brand={shell.brand} navigation={shell.navigation} officeDetails={shell.officeDetails} practiceAreas={shell.practiceAreas} tenantSlug={shell.tenant.slug}>
      <section className="mx-auto max-w-3xl px-6 py-16">
        <h1 className="text-4xl font-bold text-[var(--primary)] dark:text-white">Terms of Service</h1>
        ...
        <div className="mt-10 space-y-6">
          {SECTIONS.map((s) => (
            <article key={s.h}>
              <h2 className="text-lg font-semibold text-[var(--primary)] dark:text-white">{s.h}</h2>
