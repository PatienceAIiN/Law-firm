...
export function ActivateForm({ slug, token, email }: { slug: string; token: string; email: string }) {
  ...
  return (
    <form onSubmit={submit} className="mt-6 space-y-3">
      ...
      <button disabled={pending} className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#14203E] px-4 py-3 text-sm font-semibold text-white hover:bg-[#1d2c52] disabled:opacity-60">
