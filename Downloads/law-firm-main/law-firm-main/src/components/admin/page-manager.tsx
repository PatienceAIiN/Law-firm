  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="text-[10px] font-black uppercase tracking-[0.24em] text-[#c5a059]">Custom Pages</p>
          <h2 className="mt-2 text-2xl font-black uppercase tracking-tighter text-[#0a192f]">
        ...
        <button
          type="button"
          onClick={startCreate}
          className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#0a192f] px-5 py-3 text-[10px] font-black uppercase tracking-[0.24em] text-white transition-colors hover:bg-[#c5a059] hover:text-[#0a192f]"
        >
        ...
        {sortedPages.map((page) => (
          <div key={page.id} className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.24em] text-[#c5a059]">{page.slug}</p>
            ...
            <div className="mt-5 grid grid-cols-3 gap-2">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 px-3 py-2 text-[10px] font-black uppercase tracking-[0.22em] text-slate-600 transition-colors hover:border-[#0a192f] hover:text-[#0a192f]"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <button
                ...
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl border border-slate-200 px-5 py-3 text-[10px] font-black uppercase tracking-[0.24em] text-slate-600 transition-colors hover:border-[#0a192f] hover:text-[#0a192f]"
              >
              ...
              <button
                type="button"
                onClick={saveDraft}
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-[#0a192f] px-5 py-3 text-[10px] font-black uppercase tracking-[0.24em] text-white transition-colors hover:bg-[#c5a059] hover:text-[#0a192f]"
              >
        ...
        {previewPage && (
          <div className="space-y-6">
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
              <p className="text-[10px] font-black uppercase tracking-[0.24em] text-[#c5a059]">{previewPage.slug}</p>
