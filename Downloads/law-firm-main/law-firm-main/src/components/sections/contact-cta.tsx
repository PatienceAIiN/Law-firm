...
export function ContactCTA({ metrics, content }: ContactCTAProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-[#fbfcfe] to-white py-20 text-[#0a192f]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center rounded-full border border-[#c5a059]/30 bg-[#c5a059]/15 px-3 py-1 text-[10px] font-black uppercase tracking-[0.24em] text-[#c5a059]">
          ...
          <h2 className="mt-5 text-3xl font-black uppercase tracking-tighter lg:text-5xl">
            ...
            <span className="text-[#c5a059]">{section.title?.split(' ').slice(4).join(' ') || 'Legal Needs?'}</span>
          </h2>
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Button asChild size="lg" className="group h-14 rounded-2xl border border-[#0a192f] bg-[#0a192f] px-8 font-black uppercase tracking-widest text-white transition-all duration-300 hover:-translate-y-1 hover:bg-[#c5a059] hover:text-[#0a192f] hover:shadow-2xl hover:shadow-black/20">
              <Link href="/contact">
