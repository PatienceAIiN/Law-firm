    ...
    <article className="min-h-screen bg-white">
      <header className="bg-[#f8fafc] py-24 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          <Link
            href="/blog"
            className="inline-flex items-center text-[#c5a059] font-bold text-xs tracking-widest uppercase hover:text-[#0a192f] transition-colors"
          >
            <ArrowLeft className="w-4 h-4 mr-2" />
            BACK TO INSIGHTS
          </Link>
          <div className="space-y-4">
            <h1 className="text-4xl lg:text-6xl font-black text-[#0a192f] leading-tight uppercase tracking-tighter">
              {post.title}
            </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div
          className="prose prose-xl prose-navy max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tighter prose-p:leading-relaxed prose-p:text-gray-600 prose-strong:text-[#0a192f]"
