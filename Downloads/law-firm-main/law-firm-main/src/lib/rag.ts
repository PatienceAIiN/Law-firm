...
const KNOWLEDGE_BASE: Document[] = [
  ...
  // Site-specific content
  {
    ...
    We offer consultation modes: In-Person at our office, Jitsi Meet virtual sessions, and Zoom virtual sessions.
  ...
  },
  {
    ...
    3. Choose your preferred meeting mode: Physical (in-person), Jitsi Meet, or Zoom.
    ...
    Meeting links for Jitsi Meet or Zoom will be auto-generated and sent by email.`
  },
  {
    id: 'site-3',
